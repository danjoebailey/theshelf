      ...
      <div onClick={() => setExpanded(e => !e)} style={{ background:WOOD.card, borderRadius:12, padding:"14px 16px", border:`1px solid ${WOOD.cardBorder}`, borderLeft:"4px solid #8a5a28", boxShadow:"0 1px 4px rgba(0,0,0,0.08)", cursor:"pointer", display:"flex", alignItems:"center", gap:12 }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:5, marginTop:2 }}>
            {topGenre && <span style={{ display:"inline-block", background:GENRE_COLORS[topGenre]||"#94a3b8", color:"#fff", borderRadius:20, padding:"2px 8px", fontSize:9, fontFamily:"'DM Sans',sans-serif", fontWeight:700, textTransform:"uppercase", letterSpacing:"0.08em" }}>{topGenre}</span>}
            <TierBadge tier={tier} onSetTier={onSetTier} />
            {avgRating && <span style={{ fontFamily:"'DM Sans',sans-serif", fontSize:11, color:WOOD.textDim }}>★ {avgRating}</span>}
          </div>
        </div>
        <div style={{ display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
          <button {...tc(() => onAuthor && onAuthor(authorName), true)} style={{ background:"transparent", border:"none", cursor:"pointer", padding:"2px 4px 0", color:"rgba(120,70,20,0.6)", fontSize:16, lineHeight:1 }}>↗</button>
          ...
          <div style={{ textAlign:"center", padding:"48px 24px" }}>
            {generating ? (
              <>
                ...
                />
                <p style={{ fontFamily:"'Crimson Pro',serif", fontSize:20, fontStyle:"italic", color:"#ffffff", marginTop:14 }}>Obi is working his magic…</p>
              </>
            ) : (
              <p style={{ fontFamily:"'Crimson Pro',serif", fontSize:16, fontStyle:"italic", color:"rgba(255,235,195,0.35)" }}>
                {entityType === "authors"
