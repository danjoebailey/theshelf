        ...
        <div style={{
          ...
          {[{ id:"shelf", label:"Shelf" },{ id:"stats", label:"Breakdown" },{ id:"reiko", label:"Reiko" },{ id:"rankings", label:"Rankings" }].map(({ id,label })=>(
            <button key={id}
              ...
              <span style={{
                padding: id==="shelf" ? "0px 6px" : id==="stats" ? "9px 10px" : id==="reiko" ? "4px 10px" : id==="rankings" ? "0px 10px" : "6px 10px", borderRadius:20,
                ...
                {id==="shelf"
                  ...
                  : id==="rankings"
                  ? <img src="/books_1_2_no_bg.png" alt="Rankings" style={{ height:36, width:"auto", display:"block", opacity: tab===id ? 1 : 0.55, transition:"opacity 0.2s" }} />
                  : label}
              </span>
            </button>
          ))}
