export default async function handler(req, res) {
  ...
  const categoryStr = category === "all" ? "" : `. Rank strictly by ${category} quality only — a book that is acclaimed overall but weak in ${category} should not appear, and a lesser-known book with exceptional ${category} should rank above a famous one with mediocre ${category}`;
